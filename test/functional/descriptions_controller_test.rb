...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { address: @description.address, information: @description.information, name: @description.name, phone: @description.phone, picture: @description.picture }
    end
  ...
  test "should update description" do
    put :update, id: @description, description: { address: @description.address, information: @description.information, name: @description.name, phone: @description.phone, picture: @description.picture }
    assert_redirected_to description_path(assigns(:description))
  end
